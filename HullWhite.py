...
def Paths(NoOfPaths: int, NoOfSteps: int, T: int, P0t: callable, a: float, sigma: float, epsilon: float)->dict:
    """
...
def Run_Hull_White(asset_id: int)->list:
    ...
    # Final comparison
    [t, P, implied_term_structure, M, I] = mainCalculation(NoOfPaths, NoOfSteps, T, a, sigma, P0t, epsilon)
